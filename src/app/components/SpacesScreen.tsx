                ...
                const roadmapSections = [
                  {
                    ...
                    items: [
                      ...
                      { title: "Oeffentliche Space-Suche", desc: "Directory-Endpoint mit Tags, Sortierung und Heartbeat." },
                      { title: "Spaces Kachel-Navigation", desc: "Ersetzt die alte Tab-Leiste — Drag & Drop, volle Breite, Beschreibung." },
                      { title: "Space Beitritts-System mit Genehmigung", desc: "Beitrittsanfragen, Gruender-Genehmigung, P2P + Server-Buffer fuer Offline." },
                      { title: "Echtzeit-Sync fuer Spaces", desc: "Icon, Beschreibung, Mitglieder, Rollen — alles synchron zwischen Geraeten." },
                      { title: "Rollen-System neu", desc: "Gruender, Admin, Custom Rollen mit einzeln waehlbaren Berechtigungen." },
                      { title: "Spaces QR-Code Einladungssystem", desc: "Server-Registry, Heartbeat, auto-cleanup — Kurzcode statt Base64." },
                      { title: "GitHub Support-System", desc: "Support-Chat erstellt GitHub Issues, Arego-ID Vertrauenssystem, Rate-Limiting." },
                      { title: "Gossip Protocol P2P Sync", desc: "Dezentraler Sync — kein Single Point of Failure, jedes Mitglied kann syncen." },
                    ],
                  },
                  {
                    key: "wip",
